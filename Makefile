#############################################################################
# Makefile for building: HalloWelt
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  ../HalloWelt/HalloWelt.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile ../HalloWelt/HalloWelt.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../HalloWelt -I. -I/usr/include/qt5 -I/usr/include/qt5/QtCore -I. -I/../lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = HalloWelt1.0.0
DISTDIR = /home/timeirich/build-HalloWelt-Desktop-Debug/.tmp/HalloWelt1.0.0
LINK          = g++
LFLAGS        = 
...
DIST          = /../lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		../HalloWelt/HalloWelt.pro  ../HalloWelt/main.cpp
QMAKE_TARGET  = HalloWelt
DESTDIR       = 
TARGET        = HalloWelt
...
Makefile: ../HalloWelt/HalloWelt.pro /../lib64/qt5/mkspecs/linux-g++/qmake.conf /../lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/../lib64/qt5/mkspecs/features/yacc.prf \
		/../lib64/qt5/mkspecs/features/lex.prf \
		../HalloWelt/HalloWelt.pro
	$(QMAKE) -o Makefile ../HalloWelt/HalloWelt.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../HalloWelt/main.cpp $(DISTDIR)/
...
moc_predefs.h: /../lib64/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -std=gnu++11 -Wall -Wextra -dM -E -o moc_predefs.h /../lib64/qt5/mkspecs/features/data/dummy.cpp
...
main.o: ../HalloWelt/main.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../HalloWelt/main.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/HalloWelt/bin || mkdir -p $(INSTALL_ROOT)/opt/HalloWelt/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/HalloWelt/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/HalloWelt/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/HalloWelt/bin/ 
